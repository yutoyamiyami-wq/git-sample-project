...
使用例：git clone https://github.com/yutotomioka/sample-project.git
使用される状況
・新しくプロジェクトに参加したとき
・別のPCで同じプロジェクトを作業したいとき
・オンライン上のソースコードを取得したいとき

git pull は、すでに clone 済みのローカルリポジトリを最新状態に更新するコマンド
使用例：git pull origin main
使用される状況
・チームメンバーが変更を加えた後
・作業を再開する前に最新状態を確認したいとき
